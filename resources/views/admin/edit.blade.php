                    ...
                    <div class="col-md-8">
                        ...
                        <div class="col-md-6">
                            <div class="inline-form">
                                <label class="c-label">User name</label><input class="input-style" name="name" type="text" value="{{$hotUser[0]->name}}" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="inline-form">
                                {{--<label class="c-label"></label><input class="input-style" type="text" value="{{$hotUser[0]->display_name}}" />--}}
                                <select name="role">
                        ...
                        <div class="col-md-6">
                            <div class="inline-form">
                                <label class="c-label" >Email</label><input  name="email" type="text" value="{{$hotUser[0]->email}}"/>
                            </div>

                        </div>
                        <div class="col-md-6">
                            <div class="inline-form">
                                <input type="hidden" name="id" value="{{$hotUser[0]->id}}">
                                <input type="hidden" name="role_name" value="{{$hotUser[0]->role_name}}">
                                <label class="c-label">Password</label><input  name="password" type="password" placeholder="********"/>
                            </div>
