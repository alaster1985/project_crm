            ...
            <div class="row">
                <div class="masonary-grids">
                    <div class="col-md-8">
                        ...
                        <form action="{{url('admin/createUsers')}}" method="post">

                            <h2 class="StepTitle">Create Account</h2>
                            <div class="col-md-6">
                                <div class="inline-form">
                                    <input class="input-style" name="name" type="text" required="required" placeholder="User name" />
                                </div>
                                <div class="inline-form">
                            ...
                            <div class="col-md-6">
                                <div class="inline-form">
                                    ...
                                    <label class="c-label">Role</label><select  name="role">

                                        @foreach($role as $value)
                                            @if($value->display_name == 'Admin' and $user->hasRole('admin'))
                                             @continue;
                                            @endif
