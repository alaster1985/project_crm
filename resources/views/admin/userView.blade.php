                ...
                <div class="masonary-grids">
                    <div class="col-md-8">
                        ...
                        <table id="tasksT" class="table table-bordered table-hover table-sm">
                            <thead>
                            <tr>
                                <th class="col-xs-2 head" style="position: sticky;top: 0;background: white;">User name
                                </th>

                                <th class="col-xs-2 head" style="position: sticky;top: 0;background: white;">Email
                                </th>
                                <th class="col-xs-1 head" style="position: sticky;top: 0;background: white;">Role
                                </th>
                                @unless($user->hasRole('admin'))
                                <th class="col-xs-1 head" style="position: sticky;top: 0;background: white;">Edit
                                </th>
                                <th class="col-xs-1 head" style="position: sticky;top: 0;background: white;">Delete
                                </th>
                                @endunless
                            </tr>
                            @foreach($allUsers as $value)
                                <tr>
                                    ...
                                    @unless($user->hasRole('admin'))
                                        @if($value->display_name =="Super Admin")
                                            @continue;
                                        @endif
                                    {{--<form action="{{}}"--}}
                                    <th><a class="btn btn-link glyphicon glyphicon-plus" href={{route("user_edit", $value->id)}}></a></th>
                                    <th><a class="btn btn-link glyphicon glyphicon-minus"  href="{{route("user_delete", $value->id)}}"></a></th>
                                    @endunless
                                </tr>
                             @endforeach
                            </thead>
